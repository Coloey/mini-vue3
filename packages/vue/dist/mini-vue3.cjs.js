...
function shallowReadonly(target) {
    return createReactiveObject(target, shallowReadonlyMap, shallowReadonlyHanlders);
}
...
function createRenderer(options) {
    const { createElement: hostCreateElemet, setElementText: hostSetElementText, patchProp: hostPatchProp, insert: hostInsert, remove: hostRemove, setText: hostSetText, createText: hostCreateText } = options;
    ...
    function setupRenderEffect(instance, initialVNode, container) {
        function componentUpdateFn() {
            if (!instance.isMounted) {
                ...
                initialVNode.el = subTree === null || subTree === void 0 ? void 0 : subTree.el;
...
function traverseChildren(parent, context) {
    var _a;
    (_a = parent.children) === null || _a === void 0 ? void 0 : _a.forEach((node) => {
